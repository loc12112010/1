...
def Main():
    ...
    os.system("cls" if os.name == "nt" else "clear")
    print("\033[92m     YTB: Duy Tricker")
    print("     Tool spam sms free, cần kết nối internet để hoạt động.\n")
    statuss = requests.get("https://duy28.tk/spamsmsv1.txt")
    if statuss.text != "ok":
        print("     Tool đã hết hạn, vui lòng tìm phiên bản mới trên YTB:",blue+"Duy Tricker.")
        exit()
    while True:
